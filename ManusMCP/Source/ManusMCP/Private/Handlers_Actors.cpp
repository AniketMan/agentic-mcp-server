// Handlers_Actors.cpp
// Actor management handlers for ManusMCP.
...
// ============================================================
// HandleListActors
// POST /api/list-actors { "classFilter": "BP_TeleportPoint", "nameFilter": "", "level": "" }
// ============================================================

FString FManusMCPServer::HandleListActors(const FString& Body)
{
...
// ============================================================
// HandleGetActor
// POST /api/get-actor { "name": "BP_TeleportPoint_C_0" }
// ============================================================

FString FManusMCPServer::HandleGetActor(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
...
// ============================================================
// HandleSpawnActor
// POST /api/spawn-actor { "className": "BP_TeleportPoint", "label": "TP_01",
//                          "locationX": 0, "locationY": 0, "locationZ": 0 }
// ============================================================

FString FManusMCPServer::HandleSpawnActor(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
	...
	UE_LOG(LogTemp, Display, TEXT("ManusMCP: Spawned '%s' (%s) at (%.0f, %.0f, %.0f)"),
...
// ============================================================
// HandleDeleteActor
// POST /api/delete-actor { "name": "BP_TeleportPoint_C_0" }
// ============================================================

FString FManusMCPServer::HandleDeleteActor(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
...
// POST /api/set-actor-property { "name": "BP_TeleportPoint_C_0", "property": "TeleportIndex", "value": "3" }
// ============================================================

FString FManusMCPServer::HandleSetActorProperty(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
...
FString FManusMCPServer::HandleSetActorTransform(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
