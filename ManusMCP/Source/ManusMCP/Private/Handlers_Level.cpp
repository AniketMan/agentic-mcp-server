// Handlers_Level.cpp
// Level management handlers for ManusMCP.
...
FString FManusMCPServer::HandleListLevels(const FString& Body)
{
...
// ============================================================
// HandleLoadLevel
// POST /api/load-level { "levelPath": "/Game/Maps/Game/Trailer/Levels/SLs/SL_Trailer_Logic" }
// ============================================================

FString FManusMCPServer::HandleLoadLevel(const FString& Body)
{
...
// POST /api/get-level-blueprint { "level": "SL_Trailer_Logic" }
// ============================================================

FString FManusMCPServer::HandleGetLevelBlueprint(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
