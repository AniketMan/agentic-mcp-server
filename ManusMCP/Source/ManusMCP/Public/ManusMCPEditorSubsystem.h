...
// Editor subsystem that hosts the ManusMCP HTTP server inside the running UE5 editor.
...
#include "ManusMCPEditorSubsystem.generated.h"

/**
 * UManusMCPEditorSubsystem
 *
 * Automatically starts the ManusMCP HTTP server when the UE5 editor opens.
 ...
 */
UCLASS()
class UManusMCPEditorSubsystem : public UEditorSubsystem, public FTickableEditorObject
{
	GENERATED_BODY()
...
private:
	...
	TUniquePtr<FManusMCPServer> Server;
};
