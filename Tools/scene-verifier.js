...
const SCENE_REQUIREMENTS = {
  0: {
    ...
    actors: [
      ...
      { name: "BP_LocationMarker", required: true, desc: "Position 1 marker", count: 2 },
    ...
    blueprints: [
      { name: "BP_Door_Tutorial", makeTempBP: true, desc: "Door with UGrabbableComponent snap mode" },
    ],
    levelSequences: [],
    interactions: [
  ...
  2: {
    ...
    actors: [
      ...
      { name: "BP_TeleportPoint", required: true, desc: "Table teleport point" },
    ...
    blueprints: [
      { name: "BP_Illustration", makeTempBP: true, desc: "Paper with UGrabbableComponent + UWidgetComponent" },
    ],
    levelSequences: [
      { name: "LS_2_1", desc: "Heather at table drawing", bound: ["BP_HeatherPreTeen2"] },
      { name: "LS_2_2R", desc: "Illustration animates", bound: [] },
    ],
    interactions: [
      { type: "TRIGGER", desc: "Table marker overlap disables teleport", actor: "BP_LocationMarker", event: "OnComponentBeginOverlap" },
      { type: "GRAB", desc: "Illustration grab plays LS_2_2", actor: "BP_Illustration", event: "OnInteractionStart" },
      { type: "GRAB", desc: "Door grab opens to Scene 03", actor: "BP_Door", event: "OnInteractionStart" },
    ],
    audioLoop: true,
    storySteps: [1, 2, 3],
  },
  ...
  3: {
    ...
    blueprints: [
      { name: "BP_Fridge", makeTempBP: true, desc: "Fridge with door open/close logic" },
      { name: "BP_Glass", makeTempBP: true, desc: "Glass with FillLevel material parameter" },
    ],
    levelSequences: [
  ...
  5: {
    ...
    interactions: [
      { type: "TRIGGER", desc: "Chair marker overlap sits Susan down", actor: "BP_LocationMarker", event: "OnComponentBeginOverlap" },
      { type: "GAZE", desc: "Gaze at Heather during conversation", actor: "BP_Heather_Adult", event: "OnInteractionStart" },
      { type: "GRAB", desc: "Hand hold interaction", actor: "BP_Heather_Adult", event: "OnInteractionStart" },
    ],
    audioLoop: true,
    storySteps: [1, 2, 3, 4],
  },
  ...
  6: {
    ...
    interactions: [
      ...
      { type: "GRAB", desc: "Cradle sphere pull and release", actor: "BP_CradleSphere", event: "OnInteractionEnd" },
  ...
  7: {
    ...
    level: "ML_Hospital",
    actors: [
      { name: "BP_PlayerStartPoint", required: true, desc: "Lobby spawn" },
    ...
    interactions: [
      ...
      { name: "GRAB", desc: "Number card grab starts hallway walk", actor: "BP_NumberCard", event: "OnInteractionStart" },
    ],
    audioLoop: true,
    storySteps: [1, 2, 3, 4, 5, 6],
  },
  ...
  8: {
    ...
    actors: [
      ...
      { name: "BP_PourablePitcher", required: true, desc: "Pitcher for teen match (reused)" },
      { name: "BP_PhoneInteraction", required: true, desc: "Phone for adult match (reused)" },
      { name: "BP_PhotoDropZone", required: true, desc: "Photo drop zones", count: 4 },
    ],
    blueprints: [
  ...
  9: {
    ...
    blueprints: [],
    levelSequences: [
      { name: "LS_9_1", desc: "Flowers begin blooming", bound: [] },
      { name: "LS_9_2", desc: "Foundation imagery", bound: [] },
      { name: "LS_9_3", desc: "Youth programs", bound: [] },
      { name: "LS_9_4", desc: "NO HATE Act signing", bound: [] },
      { name: "LS_9_5", desc: "Media appearances", bound: [] },
      { name: "LS_9_6", desc: "Sunrise finale", bound: [] },
    ],
    interactions: [],
    audioLoop: true,
    storySteps: [1, 2, 3, 4, 5, 6],
