// Handlers_Read.cpp
// Blueprint read-only handlers for AgenticMCP.
...
FString FAgenticMCPServer::HandleGetBlueprint(const TMap<FString, FString>& Params)
{
...
FString FAgenticMCPServer::HandleGetGraph(const TMap<FString, FString>& Params)
{
...
FString FAgenticMCPServer::HandleSearch(const TMap<FString, FString>& Params)
{
...
FString FAgenticMCPServer::HandleFindReferences(const TMap<FString, FString>& Params)
{
...
FString FAgenticMCPServer::HandleListClasses(const FString& Body)
{
...
FString FAgenticMCPServer::HandleListFunctions(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
...
FString FAgenticMCPServer::HandleListProperties(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
...
FString FAgenticMCPServer::HandleGetPinInfo(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
