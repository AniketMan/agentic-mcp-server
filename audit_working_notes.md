...
9. SOH_MECHANICS_CATALOG.md (66 lines) - SOH interaction catalog
...
14. scripts/soh_inject_interactions.py (433 lines) - SOH injection script (Workflow B)
...
But `scripts/soh_inject_interactions.py` exists and is tracked. `core/script_generator.py` exists and is tracked.
...
- scripts/soh_inject_interactions.py
...
### G6: SOH_MECHANICS_CATALOG has wrong scene-to-file mapping
Line 63-66 says:
