# Scene 6: Charlottesville Rally

## Level Information
- **Level Path:** `/Game/Maps/Game/Scene6/Levels/SLs/SL_Scene6_Logic`
- **Display Name:** Scene 6 (Charlottesville Rally)
- **Total Interactions:** 5

## Notes
Independent level blueprint. No shared dependencies.

## Interaction Definitions

| Step | Event Name | Trigger | Actor | Description |
|------|-----------|---------|-------|-------------|
| 19 | `Scene6_ComputerActivated` | Nav | TBD | NAV to computer + echo chamber (LS_6_1) |
| 20 | `Scene6_WeightPlaced` | Grip | TBD | GRIP weight on balance scale (LS_6_2) |
| 21 | `Scene6_CradlePulled` | Grip | TBD | GRIP pull Newton's Cradle (LS_6_3) |
| 22 | `Scene6_SignGrabbed` | Grip | TBD | GRIP torn protest sign -> car drops (LS_6_4) |
| 23 | `Scene6_PhoneGrabbed` | Grip | TBD | GRIP floating phone -> phone call plays (LS_6_5) |
...
3. Call `load_level` with path `/Game/Maps/Game/Scene6/Levels/SLs/SL_Scene6_Logic`.
...
4. Remove `LOCK.json`.
5. Run `p4 submit -d "Scene 6: wired 5 interactions"` to submit the changelist.
